...
static void bench_sign_and_verify_free(const bench_options_free_t *options) {
  ...
  case 16:
    instance.aes_params = {16, 16, 1, 50};
    break;
  case 24:
    instance.aes_params = {24, 16, 2, 104};
    break;
  case 32:
    instance.aes_params = {32, 16, 2, 125};
    break;
  default:
  ...
  printf("Instance: N=%d, tau=%d, m1=%d, m2=%d, AES-Keylen=Seclvl=%d\n",
         instance.num_MPC_parties, instance.num_rounds, instance.m1,
         instance.m2, instance.aes_params.key_size);
...
int main(int argc, char **argv) {
  bench_options_free_t opts = {0, 0, 0, 0, 0, 0};
